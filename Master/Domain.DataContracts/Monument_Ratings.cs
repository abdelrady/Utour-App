...
namespace Domain.DataContracts
{
    ...
    public partial class Monument_Ratings: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupTourist(Tourist previousValue)
        {
            ...
            if (previousValue != null && previousValue.Monument_Ratings.Contains(this))
            {
                previousValue.Monument_Ratings.Remove(this);
            }
    
            if (Tourist != null)
            {
                if (!Tourist.Monument_Ratings.Contains(this))
                {
                    Tourist.Monument_Ratings.Add(this);
                }
        ...
        private void Fixuplayerhotspot(layerhotspot previousValue)
        {
            ...
            {
                if (!layerhotspot.Monument_Ratings.Contains(this))
                {
                    layerhotspot.Monument_Ratings.Add(this);
                }
