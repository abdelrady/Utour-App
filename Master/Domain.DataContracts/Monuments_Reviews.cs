...
namespace Domain.DataContracts
{
    ...
    public partial class Monuments_Reviews: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        {
            get { return _tourist_ID; }
            set
            {
                if (_tourist_ID != value)
                {
                    ChangeTracker.RecordOriginalValue("Tourist_ID", _tourist_ID);
                    if (!IsDeserializing)
                    {
                    ...
                    _tourist_ID = value;
                    OnPropertyChanged("Tourist_ID");
                }
            }
        }
        private int _tourist_ID;
        ...
        private void FixupTourist(Tourist previousValue)
        {
            ...
            if (previousValue != null && previousValue.Monuments_Reviews.Contains(this))
            {
                previousValue.Monuments_Reviews.Remove(this);
            }
    
            if (Tourist != null)
            {
                if (!Tourist.Monuments_Reviews.Contains(this))
                {
                    Tourist.Monuments_Reviews.Add(this);
                }
        ...
        private void Fixuplayerhotspot(layerhotspot previousValue)
        {
            ...
            {
                if (!layerhotspot.Monuments_Reviews.Contains(this))
                {
                    layerhotspot.Monuments_Reviews.Add(this);
                }
