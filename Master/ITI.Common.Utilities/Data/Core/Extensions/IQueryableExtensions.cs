...
namespace ITI.Common.Utilities.Data.Core.Extensions
{
    /// <summary>
    ...
    public static class IQueryableExtensions
    {
            ...
            where TEntity : class
        {
            if (String.IsNullOrEmpty(path))
                throw new ArgumentNullException(ITI.Common.Utilities.Data.Core.Messages.exception_IncludePathCannotBeNullOrEmpty);
            ...
            where TEntity : class
        {
            if (expression == (Expression<Func<TEntity, S>>)null)
                throw new ArgumentNullException(ITI.Common.Utilities.Data.Core.Messages.exception_ExpressionPathNotValid);
            ...
            {
                throw new ArgumentException(ITI.Common.Utilities.Data.Core.Messages.exception_ExpressionPathNotValid);
            }
            else
