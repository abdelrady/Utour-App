...
using ITI.Common.Utilities.Properties;

namespace ITI.Common.Utilities.TypeResolution
{
    /// <summary>
        ...
        : ITypeAdapter
    {
        ...
        /// <summary>
        /// <see cref="ITI.Common.Utilities.TypeResolution.ITypeAdapter"/>
        /// </summary>
        /// <typeparam name="TSource"><see cref="ITI.Common.Utilities.TypeResolution.ITypeAdapter"/></typeparam>
        /// <typeparam name="TTarget"><see cref="ITI.Common.Utilities.TypeResolution.ITypeAdapter"/></typeparam>
        /// <param name="source"><see cref="ITI.Common.Utilities.TypeResolution.ITypeAdapter"/></param>
        /// <returns><see cref="ITI.Common.Utilities.TypeResolution.ITypeAdapter"/></returns>
        ...
        /// <typeparam name="TTarget"><see cref="ITI.Common.Utilities.TypeResolution.ITypeAdapter"/></typeparam>
        /// <param name="source"><see cref="ITI.Common.Utilities.TypeResolution.ITypeAdapter"/></param>
        /// <param name="moreSources"><see cref="ITI.Common.Utilities.TypeResolution.ITypeAdapter"/></param>
        /// <returns><see cref="ITI.Common.Utilities.TypeResolution.ITypeAdapter"/></returns>
