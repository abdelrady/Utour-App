...
namespace ITI.Common.Utilities.TypeResolution
{
    ...
    public class CachedTypeResolver : ITypeResolver
    {
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="ITI.Common.Utilities.TypeResolution.CachedTypeResolver"/> class.
        /// </summary>
        /// <param name="typeResolver">
        /// The <see cref="ITI.Common.Utilities.TypeResolution.ITypeResolver"/> that this instance will delegate
