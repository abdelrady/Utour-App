...
{
    /// <summary>
    /// This module is responsible on sending notifications
    ...
    public class NotificationSender:IDisposable
    {
        ...
        //public NotificationSender(NotifierHostType type, string hostName)
        //{
        //}
       ...
       /// <summary>
       /// configured to send to ApplicationSupport
       /// </summary>
       /// <param name="sendAllOnce"></param>
       /// <param name="resendInFailure"></param>
       /// <param name="async"></param>
       /// <param name="messageBody"></param>
       /// <returns></returns>
        //public void Send(bool sendAllOnce, bool resendInFailure, bool async, string messageBody)
        //{
        //}
        ...
        public bool Send(bool sendAllOnce, bool resendInFailure, bool async, string from, string to, string[] cc, string subject, string displayName, string messageBody, Stream attachedFile)
        {
