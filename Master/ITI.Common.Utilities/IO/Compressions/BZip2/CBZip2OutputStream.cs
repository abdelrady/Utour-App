...
namespace ITI.Common.Utilities.IO.Compressions.BZip2
{
    /// <summary>
    ...
    /// </summary>
    /// <remarks>This package is based on the work done by Keiron Liddle, Aftex Software <keiron@aftexsw.com> to whom the Ant project is very grateful for his
    /// great code.</remarks>
    public class CBZip2OutputStream : Stream
    {
        ...
        /// <summary>
        /// If you are ever unlucky/improbable enough to get a stack overflow whilst sorting,
        /// increase the following constant and try again.  In practice I have never seen the
        /// stack go above 27 elems, so the following limit seems very generous.
        /// </summary>
